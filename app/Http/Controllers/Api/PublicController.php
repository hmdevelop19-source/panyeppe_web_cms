...
class PublicController extends Controller
{
    ...
    public function getHomeData()
    {
        return Cache::remember('home_data', 3600, function () {
            ...
            return [
                ...
                'gallery' => Media::where('show_in_gallery', true)->latest()->take(8)->get(),
                'stats' => [
    ...
    {
        $gallery = Media::where('show_in_gallery', true)->latest()->paginate(24);
    ...
    public function globalSearch(Request $request)
    {
        $q = $request->query('q');
        if (! $q) {
            return response()->json(['posts' => [], 'agendas' => [], 'announcements' => []]);
        }
